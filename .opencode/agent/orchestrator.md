...
**SUBAGENTS (reader, coder, reviewer)**
- Preferred: Use Task tool
- Allowed: Use delegate tool if you want a single, consistent delegation path
...
// Allowed alternative
// delegate(to: "coder", task: "...", async: false)
```
...
**Delegate is now permitted for subagents, but Task remains preferred for clarity.**
